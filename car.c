...
int main(int argc,char **argv)
{
	...
	printf("\t\t\t\t\t\t\t DEPt. OF CSE\n\n");
	printf("\t\t\t\t\t\t A MINI PROJECT ON RACE CAR\n\n");
	printf("\t\t\t SUBMITTED BY \t\t\t\t\t\t\tUNDER THE GUIDANCE OF\n\n");
	printf("\t\t\t ALFIYA SAMA  \t\t\t\t\t\t\tDR BINDIYA M K\n\n");
	printf("\t\t\t ARUSHI PUNDIR\t\t\t\t\t\t\tJYOTHI P K\n\n");


printf("\n\n\n\n\n\n\n");
	printf("\t**RACING CAR IN A RACE TRACK**\n");
	printf("\n\tPRESS:\n");
	printf("\tG or g:To Start or Continue\n");
	printf("\tE or e:To Stop\n");
	printf("\tH or h :Helicopter View\n");
	printf("\tB or b :Back View\n");
	printf("\tS or s :Side View\n");
	printf("\tF or f :Front View\n");
